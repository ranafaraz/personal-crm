        ...
        <form method="POST" action="{{ route('opportunities.store') }}" class="space-y-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="md:col-span-2">
                    ...
                    <x-rich-editor name="description" :value="old('description')" placeholder="Job description, scholarship details, research topic..." />
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <x-rich-editor name="notes" :value="old('notes')" />
                </div>
            </div>
