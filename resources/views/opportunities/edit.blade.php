        ...
        <form method="POST" action="{{ route('opportunities.update', $opportunity) }}" class="space-y-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="md:col-span-2">
                    ...
                    <x-rich-editor name="description" :value="old('description', $opportunity->description)" placeholder="Job description, scholarship details, research topic..." />
                </div>
                ...
                @php
                    ...
                    $selectedContactIds = collect(old('contacts', $opportunity->contacts->pluck('id')->all()))->map(fn ($v) => (int) $v)->values();
                @endphp
