        ...
        <form method="POST" action="{{ route('contacts.update', $contact) }}" class="space-y-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                @php
                    ...
                    $selectedOpportunityIds = collect(old('opportunities', $contact->opportunities->pluck('id')->all()))->map(fn ($v) => (int) $v)->values();
                @endphp
                ...
                <div class="md:col-span-2">
                    ...
                    <x-rich-editor name="notes" :value="old('notes', $contact->notes)" placeholder="Notes about this contact..." />
                </div>
            </div>
