...
<div class="max-w-xl">
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-6 space-y-5">
        <div class="bg-blue-50 border border-blue-200 rounded-lg px-4 py-3 text-sm text-blue-800">
            ...
            <p class="mt-2"><strong>Pre-load emails:</strong> add a <code class="font-mono bg-blue-100 px-1 rounded">draft_email</code> column with the initial outreach body — it lands in your <em>Drafts</em> tab ready to review &amp; send. Add a <code class="font-mono bg-blue-100 px-1 rounded">followup_email</code> column and it's queued in <em>Scheduled</em> for delivery in 5 days. Both use your default email account and link automatically to the contact + opportunity.</p>
        </div>
        <div>
